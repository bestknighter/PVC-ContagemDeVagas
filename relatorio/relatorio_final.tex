...
\minipage{0.475\linewidth}
  ...
  \caption{GLCM $3\angle 0º$}\label{fig:glcm0}
\endminipage\hfill
\minipage{0.475\linewidth}
  \includegraphics[width=\linewidth]{GLCM45-Homogeneidade.jpg}
  \caption{GLCM $3\angle 45º$}\label{fig:glcm45}
\endminipage
\end{figure}
...
\minipage{0.475\linewidth}
  ...
  \caption{GLCM $3\angle 90º$}\label{fig:glcm90}
\endminipage\hfill
\minipage{0.475\linewidth}
  \includegraphics[width=\linewidth]{GLCM135-Homogeneidade.jpg}
  \caption{GLCM $3\angle 135º$}\label{fig:glcm135}
\endminipage
\end{figure}
