...
\subsection{Imagem}
	...
	A imagem utilizada ao longo do projeto foi a seguinte:
...
além do processamento de imagem, redes de aprendizagem profunda na área de
inteligência articifial. Este artigo apresenta uma abordagem para a detecção de ocupação
de estacionamento em tempo real que usa um classificador da Rede Neural Convolucional
...
pré-processamento para reduzir informações inúteis, processamento morfológico
(binarização e limiarização), extração de características e clusterização.
...
\minipage{0.475\linewidth}
  ...
  \caption{GLCM 0º}\label{fig:glcm0}
\endminipage\hfill
\minipage{0.475\linewidth}
  \includegraphics[width=\linewidth]{GLCM45-Homogeneidade.jpg}
  \caption{GLCM 45º}\label{fig:glcm45}
\endminipage
\end{figure}
...
\minipage{0.475\linewidth}
  ...
  \caption{GLCM 90º}\label{fig:glcm90}
\endminipage\hfill
\minipage{0.475\linewidth}
  \includegraphics[width=\linewidth]{GLCM135-Homogeneidade.jpg}
  \caption{GLCM 135º}\label{fig:glcm135}
\endminipage
\end{figure}
...
\includegraphics[scale=0.15]{hough-linhas-cluster.jpg}
 \caption{Retas geradas por Hough clusterizadas}
...
\includegraphics[scale=0.15]{hough-segmentolinhas-cluster.jpg}
 \caption{Segmentos de retas geradas por Hough probabilístico clusterizadas}
...
para definir a similaridade entre as retas encontradas pela Trasnformada Hough.
